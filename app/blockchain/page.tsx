      ...
      <div className="mx-auto max-w-6xl">
        <div className="mb-8 flex items-center justify-between border-b border-primary/20 pb-6">
          <div>
            ...
            <p className="mt-2 font-mono text-sm text-muted-foreground">Decentralized network integration</p>
          </div>
          <Button
            onClick={() => router.push("/dashboard")}
            className="border-green-500/50 bg-green-500/10 font-mono text-green-500 hover:border-green-500 hover:bg-green-500/20"
          >
            BACK_TO_DASHBOARD
          </Button>
        </div>
